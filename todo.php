...
// [ ] Message Title: If replying to a message, the title should match the original, maybe with a prefix. Suggest a strategy and debug the current behavior.
// [ ] Admin Panel: Previously, accepting a report deleted a post. This no longer happens because "reports" were extended to users and messages. Fix logic accordingly.
