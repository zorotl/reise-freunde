...
class PostFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        try {
            ...
            $countryCode = !empty($countryCodes) ? $this->faker->optional(80)->randomElement($countryCodes) : null; // 80% chance of having a country
        } catch (\Exception $e) {
        ...
        return [
            ...
            "city" => $countryCode ? $this->faker->optional(60)->city() : null, // Only add city if country exists
        ];
    }
