<div>
    <div class="mb-5">
        <a wire:navigate href="{{ route('pinboard.create') }}"
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white dark:bg-neutral-700 rounded-xl shadow-md overflow-hidden">
            <div class="p-6">
                <h3 class="text-xl font-semibold text-gray-900 dark:text-stone-400 mb-2">{{ $entry->title }}</h3>
                ...
                <div class="mt-4 flex items-center justify-between text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div class="space-x-2">
                        ...
                        <a wire:navigate href="/pinboard/edit/{{ $entry->id }}"
